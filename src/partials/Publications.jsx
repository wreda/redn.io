...
function Publications() {
  return (
    <section className="relative">
      ...
      <div id="publications" className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Publications */}
          <div className="max-w-6xl mx-auto mt-20 mb-20" data-aos="zoom-y-out">

 	    <cite className="block font-bold text-lg px-4 not-italic mb-1 font-sans">RDMA is Turing complete, we just did not know it yet!</cite>
       	    <div className="text-gray-600 mb-5">
	    <a className="text-blue-600 hover:underline px-4" href="https://www.usenix.org/conference/nsdi22/technical-sessions">NSDI'22</a>•<a className="px-4">April 4-6, 2022</a>
	    </div>

            <div className="text-gray-600 mb-3 px-4 font-sans">
 	  ...
 	  <a className="text-blue-600 hover:underline px-4" href={PaperPDF}><FontAwesomeIcon icon={faFilePdf} />  Read Paper</a>
	  <a className="text-gray-600 hover:underline px-4"><FontAwesomeIcon icon={faFileVideo} />  Watch Video (coming soon)</a>
